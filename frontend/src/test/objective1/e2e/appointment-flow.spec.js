...
test.describe('Appointment Manager Flow', () => {
    ...
    test('should render appointments tab and display fetched appointments', async ({ page }) => {
        ...
        // Check table rows
        await expect(page.getByText('Patient #12')).toBeVisible();
    ...
    test('should create a new appointment and refresh table list', async ({ page }) => {
        ...
        await page.locator('input[name="patient_id"]').fill('1071');
        await page.locator('input[name="doctor_id"]').fill('711');
    ...
    test('should pre-fill modal and update existing appointment', async ({ page }) => {
        ...
        await expect(page.locator('input[name="patient_id"]')).toHaveValue('12');
        await expect(page.locator('input[name="doctor_id"]')).toHaveValue('5');
    ...
    test('should handle appointment deletion after accepting native browser confirm', async ({ page }) => {
        ...
        await expect(page.getByText('Patient #12')).not.toBeVisible();
    });
